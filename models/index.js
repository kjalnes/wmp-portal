...
const Class = conn.define('class', {
  ...
  countryCode: conn.Sequelize.STRING,
...
const seed = ()=> {
  ...
  const classes = [{schoolName: 'Fullstack', size: 30, semester:'fall-17', coordinates: [40.7050758, -74.00916039999998], countryCode: 'US', imgURL: '/public/images/Uganda4.JPG'}, {schoolName: 'Spjelkavik Ungdomskole', size: 29, semester:'fall-17', coordinates: [62.46176910000001, 6.368587599999955], countryCode: 'NO', imgURL: '/public/images/Uganda4.JPG'}, {schoolName: 'Brighton Junior School Bweyogerere', size: 30, semester:'fall-17', coordinates: [0.3353678, 32.66730180000002], countryCode: 'UG', imgURL: '/public/images/Uganda4.JPG'}];

  let rolf, vegard, aase, Fullstack, Spjelkavik, Bweyogerere;

  return sync()
    // .then(()=> {
    //   return User.destroy({ truncate: truncateue });
    // })
    .then(()=> {
